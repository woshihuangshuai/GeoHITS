...
def DataProcess(user_tags_list, locations_list):
    ...
    for i in xrange(0, len(locations_list)):
        ...
        for i in xrange(0, len(tags)):
            if tags[i] in user_tags:
                ...
                # matrix_locations[locations.index(country)][i] += 1.0  # tag
                # frequency
    ...
    for i in xrange(0, len(tags)):
        ...
        num_list_of_each_tag_occur_in_locations.append(
            num_of_each_tag_occur_in_locations)
    ...
    f = open("GeoHITS_s result/%s_TABLE_OF_EACH_LOCATION_CONTAINS_TAGS" %
             keyword, 'w+')
    ...
    f = open("GeoHITS_s result/%s_TABLE_OF_EACH_TAG_OCCURS_IN_LOCATIONS" %
             keyword, 'w+')
    f.write(t.get_string())
    f.write('\n')
...
if __name__ == '__main__':
    ...
    locations, tags, matrix_locations, jaccard = DataProcess(
